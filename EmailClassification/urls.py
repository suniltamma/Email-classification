"""EmailClassification URL Configuration
...
from EmailClassification import views as mainView
...
urlpatterns = [
    ...
    path("user_view_cleaned_data/", usr.user_view_cleaned_data, name="user_view_cleaned_data"),
